...
exports.CancelListingDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var validators_1 = require("../../dto/validators");
var CancelListingDto = function () {
    var _a;
    var _sellerPublicKey_decorators;
    var _sellerPublicKey_initializers = [];
    var _sellerPublicKey_extraInitializers = [];
    return _a = /** @class */ (function () {
            function CancelListingDto() {
                this.sellerPublicKey = __runInitializers(this, _sellerPublicKey_initializers, void 0);
                __runInitializers(this, _sellerPublicKey_extraInitializers);
            }
            return CancelListingDto;
        }()),
        (function () {
...
exports.CancelListingDto = CancelListingDto;
