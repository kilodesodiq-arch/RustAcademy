...
exports.SorobanPreflightDto = void 0;
var class_validator_1 = require("class-validator");
var swagger_1 = require("@nestjs/swagger");
var SorobanPreflightDto = function () {
    var _a;
    var _sourceAccount_decorators;
    var _sourceAccount_initializers = [];
    var _sourceAccount_extraInitializers = [];
    return _a = /** @class */ (function () {
            function SorobanPreflightDto() {
                this.sourceAccount = __runInitializers(this, _sourceAccount_initializers, void 0);
                __runInitializers(this, _sourceAccount_extraInitializers);
            }
            return SorobanPreflightDto;
        }()),
        (function () {
            ...
            _sourceAccount_decorators = [(0, swagger_1.ApiProperty)({
                ...
                }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.Matches)(/^G[A-Z0-9]{55}$/, {
...
exports.SorobanPreflightDto = SorobanPreflightDto;
