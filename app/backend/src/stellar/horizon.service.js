...
var HorizonService = function () {
    ...
    var HorizonService = _classThis = /** @class */ (function () {
        function HorizonService_1(config) {
            this.config = config;
            this.logger = new common_1.Logger(HorizonService.name);
        }
        HorizonService_1.prototype.getNetwork = function () {
            return this.config.network;
        };
        HorizonService_1.prototype.getBaseUrl = function () {
         ...
         */
        HorizonService_1.prototype.getAccount = function (accountId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            url = "".concat(this.config.horizonBaseUrl, "/accounts/").concat(accountId);
                        ...
                        case 1:
                            ...
                            if (!response.ok) {
                                if (response.status === 404) {
                                    this.logger.debug("Account ".concat(accountId, " not found on Horizon"));
                        ...
                        case 3:
                            error_1 = _a.sent();
                            this.logger.warn("Failed to fetch account ".concat(accountId, ": ").concat(error_1.message));
                            return [2 /*return*/, null];
