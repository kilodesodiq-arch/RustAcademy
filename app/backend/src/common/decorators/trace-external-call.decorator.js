 ...
 */
function TraceExternalCall(service, operation) {
    return function (target, propertyKey, descriptor) {
        var originalMethod = descriptor.value;
        var logger = new common_1.Logger("".concat(service, ".").concat(operation));
        descriptor.value = function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var metricsService, startTime, correlationId, result, duration, error_1, duration, errorType;
