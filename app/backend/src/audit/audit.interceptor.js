...
var AuditInterceptor = function () {
    ...
    var AuditInterceptor = _classThis = /** @class */ (function () {
        ...
        AuditInterceptor_1.prototype.intercept = function (context, next) {
            ...
            var method = request.method, url = request.url, user = request.user, headers = request.headers;
            // Fallback info if not fully authenticated or request ID is missing
            var actor = (user === null || user === void 0 ? void 0 : user.id) || (user === null || user === void 0 ? void 0 : user.email) || 'anonymous';
            var requestId = headers['x-request-id'] || 'unknown';
            return next.handle().pipe((0, operators_1.tap)(function () {
                ...
                var action = "".concat(method, " ").concat(url);
                _this.auditService.log(actor, action, url, { method: method }, requestId);
            }));
        };
