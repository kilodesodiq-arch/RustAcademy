...
var AuditController = function () {
    var _classDecorators = [(0, common_1.Controller)('admin/audit')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _queryLogs_decorators;
    var _exportCsv_decorators;
    var _applyRetentionStrategy_decorators;
    var AuditController = _classThis = /** @class */ (function () {
        ...
        AuditController_1.prototype.queryLogs = function (query) {
            // In a real app, this route would be protected by an AdminGuard
            return this.auditService.query(query);
        };
        // Export capability (CSV)
        AuditController_1.prototype.exportCsv = function (res) {
            return __awaiter(this, void 0, void 0, function () {
                var csv;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.auditService.exportCsv()];
                        case 1:
                            csv = _a.sent();
        ...
        AuditController_1.prototype.applyRetentionStrategy = function () {
    ...
    (function () {
        ...
        _queryLogs_decorators = [(0, common_1.Get)()];
        _exportCsv_decorators = [(0, common_1.Get)('export')];
        _applyRetentionStrategy_decorators = [(0, common_1.Delete)('retention')];
        __esDecorate(_classThis, null, _queryLogs_decorators, { kind: "method", name: "queryLogs", static: false, private: false, access: { has: function (obj) { return "queryLogs" in obj; }, get: function (obj) { return obj.queryLogs; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        __esDecorate(_classThis, null, _applyRetentionStrategy_decorators, { kind: "method", name: "applyRetentionStrategy", static: false, private: false, access: { has: function (obj) { return "applyRetentionStrategy" in obj; }, get: function (obj) { return obj.applyRetentionStrategy; } }, metadata: _metadata }, null, _instanceExtraInitializers);
