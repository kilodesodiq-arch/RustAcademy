...
var metrics_guard_1 = require("./metrics.guard");
var MetricsController = function () {
    ...
    var _getContentType_decorators;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!registry) {
                                throw new common_1.InternalServerErrorException("Metrics registry not initialized");
                            }
                            if (typeof registry.metrics !== "function") {
                                throw new common_1.InternalServerErrorException("Metrics method not available");
                            }
                            return [4 /*yield*/, registry.metrics()];
                        case 1: return [2 /*return*/, _a.sent()];
                        case 2:
                            error_1 = _a.sent();
                            if (error_1 instanceof common_1.InternalServerErrorException) {
                                throw error_1;
                            }
                            throw new common_1.InternalServerErrorException("Failed to retrieve metrics");
                        case 3: return [2 /*return*/];
                    }
                });
            });
        };
        MetricsController_1.prototype.getContentType = function () {
            try {
                var registry = this.metricsService.getRegistry();
                if (!registry) {
    ...
    (function () {
        ...
        _getMetrics_decorators = [(0, common_1.Get)(), (0, common_1.UseGuards)(metrics_guard_1.MetricsGuard), (0, swagger_1.ApiOperation)({
                summary: "Get Prometheus metrics",
                description: "Returns the current metrics in Prometheus format. Requires internal metrics guard.",
        ...
        _getContentType_decorators = [(0, common_1.Get)("content-type"), (0, swagger_1.ApiOperation)({
        ...
        __esDecorate(_classThis, null, _getContentType_decorators, { kind: "method", name: "getContentType", static: false, private: false, access: { has: function (obj) { return "getContentType" in obj; }, get: function (obj) { return obj.getContentType; } }, metadata: _metadata }, null, _instanceExtraInitializers);
