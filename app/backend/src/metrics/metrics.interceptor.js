        ...
        MetricsInterceptor_1.prototype.intercept = function (context, next) {
            ...
            return next.handle().pipe((0, operators_1.tap)({
                next: function () {
                    ...
                    _this.metricsService.recordRequestDuration(method, route, res.statusCode, duration);
                },
                error: function (err) {
                    var duration = (Date.now() - start) / 1000;
                    _this.metricsService.recordRequestDuration(method, route, err.status || 500, duration);
                },
            }));
        };
