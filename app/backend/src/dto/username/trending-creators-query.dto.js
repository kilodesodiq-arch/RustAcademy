...
exports.TrendingCreatorsQueryDto = void 0;
 ...
 */
var TrendingCreatorsQueryDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function TrendingCreatorsQueryDto() {
                this.timeWindowHours = __runInitializers(this, _timeWindowHours_initializers, 24);
                this.limit = (__runInitializers(this, _timeWindowHours_extraInitializers), __runInitializers(this, _limit_initializers, 10));
            ...
            return TrendingCreatorsQueryDto;
        }()),
        (function () {
            ...
            _timeWindowHours_decorators = [(0, swagger_1.ApiProperty)({
                    ...
                    required: false,
                    default: 24,
                }), (0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(1), (0, class_validator_1.Max)(720), (0, class_transformer_1.Type)(function () { return Number; })];
            _limit_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Maximum number of trending creators to return',
                    example: 10,
                    required: false,
                    default: 10,
                }), (0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(1), (0, class_validator_1.Max)(100), (0, class_transformer_1.Type)(function () { return Number; })];
            _cursor_decorators = [(0, swagger_1.ApiProperty)({
...
exports.TrendingCreatorsQueryDto = TrendingCreatorsQueryDto;
